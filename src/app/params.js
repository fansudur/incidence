...
export const PARAM_SCHEMA = [
  ...
  { folder: '地面·地形·人物', items: [
    ...
    { key: 'showTerrain', label: '地形 (起伏·按层)', type: 'bool', def: true, note: '基面=层底斜面(Σ视角塌到画面底边, 无悬空); 边缘全幅度切断+垂直裙边(剖切模型); 永不越出安全区' },
  ...
  { folder: '显示', items: [
    ...
    { key: 'showFloor', label: '层地面 (倾斜·安全段)', type: 'bool', def: true },
